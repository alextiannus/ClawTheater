module.exports = [
"[project]/Documents/GitHub/ClawTheater/frontend/node_modules/node-fetch-native/dist/chunks/multipart-parser.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function Z(u, a) {
    ...
    let d, l, c, p, e, i;
    const A = [], H = new __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$ClawTheater$2f$frontend$2f$node_modules$2f$node$2d$fetch$2d$native$2f$dist$2f$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FormData"], O = E((s)=>{
        c += f.decode(s, {
            stream: !0
        });
    }, "onPartData"), y = E((s)=>{
        ...
        const s = new __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$ClawTheater$2f$frontend$2f$node_modules$2f$node$2d$fetch$2d$native$2f$dist$2f$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["File"](A, i, {
            type: e
        });
        H.append(p, s);
...
//# sourceMappingURL=3c5fc_node-fetch-native_dist_chunks_multipart-parser_mjs_5bab3d59._.js.map