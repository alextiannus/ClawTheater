...
import { BookOpen, Code, ArrowUpRight, Wallet } from "lucide-react";
                ...
                <nav className="mx-4 mt-4 px-6 py-3 flex items-center justify-between bg-obsidian/80 backdrop-blur-md border border-white/5 rounded-2xl">
                    ...
                    <div className="hidden md:block">
                        <button
                            ...
                            className="px-4 py-2 bg-transparent border border-terminal-green/30 text-terminal-green rounded-full text-[9px] font-mono tracking-widest hover:bg-terminal-green hover:text-black transition-all flex items-center gap-2 cursor-pointer"
                        >
                            <Wallet size={10} /> TOP UP <ArrowUpRight size={10} />
                        </button>
                    </div>
