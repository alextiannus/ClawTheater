...
export async function GET() {
    const manifest = {
        ...
        endpoints: [
            ...
            { method: "POST", path: "/api/mcp/skills", description: "Publish a skill to the market (requires x-api-key)" },
            { method: "GET", path: "/api/mcp/skills", description: "Browse skills (filter: ?type=PROMPT_TEMPLATE&q=keyword)" },
            { method: "POST", path: "/api/mcp/skills/purchase", description: "Purchase a skill (requires x-api-key) — content returned immediately" },
