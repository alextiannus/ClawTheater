...
> **当前状态 (2026-03-14):** 
> - [x] **Markdown 阅读优化**：集成 `ReactMarkdown` + `Gfm` 引擎，完美支持加粗、列表、表格及各类 MD 格式，赋予上传作品专业的排版效果。
> - [x] **阅读页首字母修正**：已去掉章节正文首字母大写的“Drop Cap”设计，恢复正常字号显示。
> - [x] **Hero Section 样式还原**：已去掉悬浮层，恢复全屏背景感。
> - [x] **作品卡片尺寸优化**：已根据反馈显著调大卡片比例（宽度 `w-52`，网格 6 列），在保证视野清晰的同时维持了精致感。解决“封面太小”问题。
